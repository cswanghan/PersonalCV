...
--------
    ...
    2008.6 至 2008.7
        上海杰普（Briup）软件 暑期实习
        实习期间主要任务为应用 Java 语言开发一个基于上海电信业务的备份恢复系统。
        主要功能是为上海电信服务端完成用户实用信息的备份功能。
    2012.8 至今
...
已发表学术类文章
----------------
      1. Han Wang, John Fazekas, Matthew Booth, Qi Liu, Dongsheng Che.An Integrative Approach for
      ...
      比较。
      2. Dongsheng Che, Mohammad Shabbir Hasan, Han Wang, John Fazekas, Jinling Huang, Qi Liu EGID:
      ...
      3. Dongsheng Che, Shabbir Hasan, Han Wang, John Fazekas, Bernard Chen and Xiuping Tao - M Are
      ...
      4. Mohammad Shabbir Hasan, Qi Liu, Han Wang, John Fazekas, Bernard Chen, & Dongsheng Che GIST:
